...
from torch_vertical_FL_train_CIFAR10_debug import Vertical_FL_Train
import optuna
import argparse
import time
import sys
...
hyper_parameters = {
	'learning_rate_top_model': 0.01/10, #/10, #1e-3, #0.000025
	'learning_rate_organization_model': 0.01/10, #5e-5/50, #0.00001
	'batch_size': 512 #2048
}
