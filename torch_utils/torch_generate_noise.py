...
class Gaussian:
  ...
  def randomise(self, data):
        ...
        grad_embedding_epsilon_tensor = torch.tensor(grad_embedding_epsilon)
        noisy_data = noisy_data.to(device)
        grad_embedding_epsilon_tensor = grad_embedding_epsilon_tensor.to(device)
        return noisy_data, grad_embedding_epsilon_tensor
