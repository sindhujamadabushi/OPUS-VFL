...
from torch_vertical_FL_train_incentive_lia_MNIST import Vertical_FL_Train
import optuna
import argparse
import time
import sys
...
hyper_parameters = {
	...
	'learning_rate_organization_model': 0.0005/86, #68
	'batch_size': 512
}
dataset = 'MNIST'
...
if __name__ == "__main__":
	...
	parser.add_argument('--organization_num', type=int, help='number of organizations, if we use vertical FL')
	...
	active_clients = [True] * default_organization_num  # Set active clients based on num_clients
