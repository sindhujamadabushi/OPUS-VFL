...
if __name__ == "__main__":
	...
	parser.add_argument('--trigger_val', type=str, default=trigger_val, help='trigger_val')
	
	parser.add_argument('--poisoning_budget', type=float, default=0.15, help='poisoning_budget')
